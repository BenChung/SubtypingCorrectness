...
Method signatures in Julia can be quite complicated, making subtyping
difficult. Julia offers programmers a rich type language, including nominal
single subtyping, union types, existential types, covariant tuples, invariant
parametric datatypes, and singleton types. These features are widely used in
libraries, but pose challenges for subtyping. The main source of inspiration
for the design of subtyping in Julia was semantic
