...
checking that the requisite guarantees hold at each type. In 
this section, we will describe the implementation of the algorithm
in OCaml. In the following section, we will then discuss the Coq
