...
\[
\union{ \tuple{t_1,t_2}}{\tuple{t_3,t_2}}  <:  \tuple{ \union{t_3}{t_1}, \union{t_1}{t_2}}
\]


If we normalize it we would get a left hand side that is the union of the
...
Julia, Jeff Bezanson for coming up with Julia's subtyping algorithm.  This
work received funding from the European Research Council under the European
Union's Horizon 2020 research and innovation programme (grant agreement
695412), the NSF (award 1544542 and award 1518844).
