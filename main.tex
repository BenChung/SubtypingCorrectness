...
\begin{abstract}
  ...
  tuples. Previous work normalized unions inside tuples to disjunctive normal form
  ahead of time. However, normalization-based algorithms suffer from two problems: complex type signatures induce space explosion, and interactions between normalization and other features of Julia’s type system render such algorithms incorrect. In this paper, we describe the algorithm that Julia
