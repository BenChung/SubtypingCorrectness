...
We also need new definitions of \c{exist} and \c{allexist} that use tree
iterators. They function identically to the algorithm presented for string
iterators (though use a different iterator representation) in
Section~\ref{cs}.
