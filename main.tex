...
% do we explain that we have both OCaml and Coq
% how clear are the code bits?
% clarify last_left_to_right; do with a fold?
% better motivate this in the intro? 
%    bit of julia?
%    other features that make this important to solve?
%    intro should be longer and take more time
% talks about semantic subtyping as if it's a fact, but doesn't explain what it is or why we should care
% figures
...
In some cases, as Julia~\cite{BezansonEKS17} or TypeScript~\cite{typescript},
