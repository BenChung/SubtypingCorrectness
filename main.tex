...
\begin{lemma}[Equivalence of Normalization and Denotation]
...
\end{theorem}
\begin{proof}
Note that \lstlisting{ex_list a bl} is true iff there exists some 
$t$ such that $a <: t$ and $t \in$\,\lstinline{bl}. Concequently,
\lstlisting{fa_ex_list a b} is true iff forall $t \in$\,\lstlinline{norm a},
