...
The \c{subtype} function checks the forall-exists relationship between two types
by calling the \c{allexists} function, starting its iteration at the initial state
...
In order to ensure that the forall-exists relation holds starting from the
given iterate, \c{allexists} needs to ensure that there exists some right-hand
