...
\emph{exponentially bigger} types.  In practice, logging and analysing
the calls to Julia runtime subtype algorithm, we often observe queries
...
\begin{verbatim}
 ...
 \end{verbatim}
\end{small}
Normalising this type before attempting to decide subtyping is not a
