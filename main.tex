...
\verb|st_choice|s which indicate which branch of a union type was taken:
...
\verb|a| according to \verb|base_subtype|, then \verb|ex_subtype| has found
...
Otherwise, \verb|ex_subtype| will use the iteration operation,
\verb|next_state|, to continue iterating through choices for \verb|b| until
