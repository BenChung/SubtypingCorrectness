...
list. The first element of the returned tuple is the initial choice string.
...
\begin{lstlisting}
let subtype(a:typ)(b:typ) = allexists a b (fst (pad a []))
\end{lstlisting}

\begin{lstlisting}
let rec allexists(a:typ)(b:typ)(f:choice list) =
  match exists a b f (fst (pad b [])) with 
