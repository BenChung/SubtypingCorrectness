...
Dezani-Ciancaglini~\cite{barbanera1991intersection}, are increasingly common
in mainstream languages. In some cases, as Julia~\cite{BezansonEKS17} or
...
performing type inference. In all cases, they play a key role in the
...
In this paper we describe the keys ideas used by the
