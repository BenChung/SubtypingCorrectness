...
Method signatures in Julia can be quite complicated, complicating subtyping.
...
libraries, but make development of a subtyping algorithm complicated. The main
source of inspiration for the design of subtyping in Julia was semantic
