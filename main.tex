...
value denoted by the right hand side for every value denoted by the left. In our
type language, we accomplish this by finding one of the constituent base types 
on the right for each base type on the left. The original subtyping algorithm 
we proposed did this by normalizing both sides to 
