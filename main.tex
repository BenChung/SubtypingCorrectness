...
property trivially holds when $\irch{i_b} = \emptyset$, and if the iterator can
step then either the current union-free type is satisfying or we defer to the
IH.

\begin{theorem}\label{trexcor}
$\c{exist}\,a\,b\,i_a\,i_b$ holds iff $\exists t\in\irch{i_b},a(i_a)= t$.
\end{theorem}
...
$\c{allexist}\,a\,b\,i_a$ holds iff $\forall a'\in \irch{i_a}{},
