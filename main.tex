...
version of \verb|subtype| based on iteration over choice trees. The \c{exist}
and \c{allexist} functions work in the same way that they did for normalized
...
The function \c{exist} above is equivalent to the choice string based \c{exist}, and determines
...
supertype of the given \verb|a|. If it is, then it terminates early with
...
\verb|forall_iter| is to \verb|allexist| what \verb|exists_iter| is to
