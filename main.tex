...
\newcommand{\irch}[1]{\ensuremath{|\c{#1}|}}
We consider the denotation of a tree iterator state $\irch{i}$ to be the
...
\begin{theorem}
\c{exist a b ia ib} holds iff $\exists \c t \in \irch{ib}, \c t = \c a(\c{ia})$
\end{theorem}
